...
2. **Absorbcia nerovností vozovky** -- pruženie musí efektívne absorbovať nerovnosti a prenášať čo najmenej otrasov a vybrácii na karosériu/rám vozidla.
...
4. **Komfort jazdy** -- systém musí izolovať posádku od nepríjemných vibrácií a otrasov a zabezpečiť tým pohodlnú jazdu.

5. **Prispôsobivosť zaťaženiu** -- systém musí byť schopný prispôsobiť sa rôznym úrovniam zaťaženia vozidla (počet cestujúcich, náklad) s čo najmenším možným dopadom na jazdné vlastnosti.
...
Nasledujúce učivo:
{{< cards >}}
  {{< card url="/obsah/2-rocnik/02-pruzenie-tlmenie/listove-pruziny" title="Listové pružiny" subtitle="Princíp činnosti, konštrukcia, hlavné časti, výhody a nevýhody...">}}
{{< /cards >}}

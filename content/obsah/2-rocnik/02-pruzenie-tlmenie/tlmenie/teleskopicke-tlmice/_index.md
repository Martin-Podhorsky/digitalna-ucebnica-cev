...
Športové a výkonné automobily, pretekárske vozidlá, terénne vozidlá a motocykle. Všade, kde je požiadavka na maximálny výkon tlmenia, rýchlu odozvu a odolnosť voči vysokému zaťaženiu.

## Porovnanie jednoplášťového a dvojplášťového tlmiča
...
Nasledujúce učivo:
{{< cards >}}
  {{< card url="/obsah/2-rocnik/02-pruzenie-tlmenie/tlmenie/tlmice-s-regulaciou" title="Tlmiče s reguláciou" subtitle="Rozdelenie, rôzne druhy systémov, ich popis, výhody a nevýhody...">}}
{{< /cards >}}

...
Pripojovacie zariadenia slúžia na spojenie ťažného vozidla s prípojným vozidlom (prívesom alebo návesom). Musia prenášať ťažné a tlačné sily, umožňovať vzájomný pohyb vozidiel v zákrutách a na nerovnom teréne, a zároveň byť dostatočne pevné, spoľahlivé a bezpečné.
...
### Ťažný záves (trailer coupling)

Záves je pripevnený na zadnom zosilnenom priečniku rámu vozidla alebo na zosilnenej časti samonosnej karosérie.

**Hlavné časti:**
- **Hlava závesu** -- prijíma oko oja prívesu
- **Záverný čap** -- zaisťuje spojenie
...
**Postup pri pripájaní samočinného závesu:**
...
4. Oko oja je usmerňované do hlavy závesu usmerňovacím krytom
...
Oko oja je kruhový otvor na konci oja prívesu, do ktorého sa zasúva záverný čap závesu.
...
{{< figure src="gulova-spojka.png" alt="Guľová spojka na prívesnom vozíku" width="70%" caption="Obr. 13.8 - Guľová spojka na prívesnom vozíku" >}}

{{< figure src="gulova-spojka-popis.png" alt="Spojenie guľovou spojkou s popisom" width="100%" caption="Obr. 13.9 - Guľová spojka na prívesnom vozíku" >}}
...
{{< figure src="kralovsky-cap-a-tocnica.png" alt="Obrázok točnice (dole) a kráľovského čapu (hore)" width="60%" caption="Obr. 13.10 - Obrázok točnice (dole) a kráľovského čapu (hore)" >}}

### Točnica

**Hlavné časti:**
- **Sedlová platňa** -- nesie hmotnosť návesu a umožňuje natáčanie
- **Mazacie drážky** -- drážky na povrchu sedlovej platne, ktoré rozvádza mazivo po klznej ploche
- **Čeľuste zámku** -- zachytávajú kráľovský čap pri nacúvaní ťahača pod náves
- **Zaisťovacia tyč** -- zaisťuje čeľuste v zatvorenej polohe
- **Rukoväť** -- slúži na manuálne ovládanie zaistenia (odomknutie pri odpájaní)
- **Západka** -- zaisťuje rukoväť v uzavretej polohe a zabraňuje samovoľnému uvoľneniu

{{< figure src="tocnica.png" alt="Točnica s popisom" width="90%" caption="Obr. 13.11 - Točnica s popisom" >}}
...
{{< figure src="JOST.avif" alt="Posuvná točnica JOST" width="50%" caption="Obr. 13.12 - Posuvná točnica JOST" >}}
...
- **2 palce (50,8 mm)** -- štandard pre bežné návesy v Európe a USA
- **3,5 palcu (88,9 mm)** -- pre ťažké návesy (nad 60 t)

Kráľovský čap:
- Je vyrobený z tepelne spracovanej ocele
...
3. Čeľuste automaticky zachytia kráľovský čap
4. Vodič skontroluje zaistenie (vizuálne alebo signalizáciou)
5. Pripojí vzduchové a elektrické vedenia
...
3. Prípojné vozidlo musí byť zabrzdené a zabezpečené klinmi
4. Náves musí byť podopretý podpornými nohami
5. Osoba usmerňujúca vodiča nesmie vstúpiť medzi vozidlá, ak je vzdialenosť väčšia ako 0,25 m
...
Nasledujúce učivo:
{{< cards >}}
  {{< card url="/obsah/2-rocnik/04-privesy-navesy/manevrovatelnost" title="Činitele ovplyvňujúce manévrovateľnosť súprav" subtitle="Popis, vplyv...">}}
{{< /cards >}}

...
### Hlavné časti:
1. **Hlavný list** -- najdlhší a najhrubší list, ktorý tvorí základ pružiny.
2. **Pomocné listy** -- postupne kratšie listy uložené pod hlavným listom, ktoré zvyšujú únosnosť pružiny.
3. **Stredová objímka** -- kovová svorka, ktorá drží listy pohromade a zabraňuje ich bočnému posuvu.
4. **Stredový čap (skrutka)** -- prechádza stredom všetkých listov a spája ich do jedného celku. Zároveň slúži na upevnenie pružiny k náprave.
5. **Ušká (oká)** -- zakrútené konce hlavného listu, ktoré slúžia na pripevnenie pružiny o rám vozidla pomocou čapov.

### Ďalšie časti:
6. **Puzdro** -- gumová alebo kovová vložka v uškách pružiny, ktorá umožňuje otáčavý pohyb a znižuje opotrebenie spojenia s rámom
7. **Spona** -- kovová objímka, ktorá obopína všetky listy a udržuje ich v správnej polohe.
...
Nasledujúce učivo:
{{< cards >}}
  {{< card url="/ucivo/2-rocnik/02-pruzenie-tlmenie/vinute-pruziny" title="Vinuté pružiny" subtitle="Parametre ovplyvňujúce vlastnosti pružín, výhody, nevýhody, rozdelenie...">}}
{{< /cards >}}
